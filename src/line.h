...
#define LINE_HALL_SENSOR_A PAL_LINE(GPIOE, GPIOA_PIN4)
#define LINE_HALL_SENSOR_B PAL_LINE(GPIOE, GPIOA_PIN5)
#define LINE_HALL_SENSOR_C PAL_LINE(GPIOE, GPIOA_PIN6)

#define LINE_THROTTLE_INPUT PAL_LINE(GPIOA, GPIOA_PIN4)
...
#define LINE_LED_1 PAL_LINE(GPIOC, GPIOC_PIN11)
